    ...
    <>
      <section id='howItWorks' className='w-full h-full bg-amber-50/20 py-12'>
        ...
        <div className='w-full h-full max-w-7xl mx-auto flex'>
            ...
            <div className='w-full h-[600px] relative flex items-center justify-center '>
              <div className='w-[2px] h-full bg-amber-500 relative'>
                ...
                <div className='w-12 h-12 bg-amber-50 border-2 border-amber-500 rounded-full absolute top-1/2 left-1/2 -translate-x-1/2 flex justify-center items-center'>
                  ...
                  <div className='w-[100px] h-fit px-2 py-1 text-center bg-gradient-to-b from-orange-500 to-amber-400 border-2 border-amber-500 absolute top-1/5 right-14 -translate-y-1/3 rounded-2xl '>Place order</div>
                </div>
                {/* ---circle3--- */}
                <div className='w-12 h-12 bg-amber-50 border-2 border-amber-500 rounded-full absolute top-4/5 left-1/2 -translate-x-1/2 flex justify-center items-center'>
                  ...
                  <div className='w-[100px] h-fit px-2 py-1 text-center bg-gradient-to-b from-orange-500 to-amber-400 border-2 border-amber-500 absolute top-1/5 left-14 -translate-y-1/3 rounded-2xl '>Get fresh meals</div></div>
                <div></div>
              </div>
          ...
          <div className='w-1/2 h-full p-5'>
            {/* ------chef---- */}
            <h3 className='text-xl text-center w-fit h-fit mx-auto border-2 border-amber-500 px-4 py-2 rounded-xl  bg-gradient-to-t from-orange-500 to-amber-400'>For Chef</h3>
            <div className='w-full h-[600px] relative flex items-center justify-center '>
              <div className='w-[2px] h-full bg-amber-500 relative'>
                {/* ---circle1--- */}
